...
- 🔭 Atualmente, estou focado em **projetos de BI** e desenvolvendo um **portfólio de análise de dados com artigos no Medium**. Estou explorando novas ferramentas de visualização, como **Power BI** e **Looker Studio**, para criar insights mais impactantes.

- 🌱 No momento, estou aprofundando meus conhecimentos em **Python** e **engenharia de dados**, com ênfase em aprimorar minhas habilidades em **SQL**.

- 🤔 Estou buscando otimizar **processos ETL** e ficaria grato por qualquer dica ou recurso que você possa compartilhar!

- 💬 Sinta-se à vontade para me perguntar sobre **Business Intelligence**, **Power BI**, **Looker Studio**, **Python**, ou qualquer outro assunto relacionado à análise de dados. Estou sempre disponível para compartilhar conhecimento e discutir ideias!
